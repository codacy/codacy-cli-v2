...
var EslintPlugins = map[string]string{
	...
	"@cityelectricalfactors/prettier":               "^1.0.2",
	"@cloudbeds/eslint-config":                      "^2.10.1",
	...
	"@namely/eslint-config-namely":                  "^7.0.0",
	...
	"@teambit/react.eslint-config-bit-react":        "^0.0.824",
	...
	"eslint-plugin-suitescript":                     "^1.3.1",
	...
	"i18next":                                       "^23.12.2",
	"laravel-mix":                                   "^6.0.49",
	"lint-config-qiwi":                              "^0.0.1-security",
	"lint-staged":                                   "^15.2.7",
	"lodash":                                        "^4.17.21",
